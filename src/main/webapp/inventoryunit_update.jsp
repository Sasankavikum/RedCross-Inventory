...
<head>
	...
	<title>Update Unit Price</title>
	
	<link rel="stylesheet" type="text/css" href="css/styles.css">
	<link rel="stylesheet" type="text/css" href="css/header.css">
	<link rel="stylesheet" type="text/css" href="css/footer.css">
	<link rel="stylesheet" type="text/css" href="css/inventoryunit_update.css">	
...
<body>
    ...
    <div class="col-25">
    	...
    	<div class="col-75">
      		<input type="number" name="unit" value="<%=resultSet.getString("unit") %>"> 
    </div>
  	</div>
